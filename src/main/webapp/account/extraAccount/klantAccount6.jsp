...
<link rel="stylesheet" type="text/css" href="accountCss/mystyles6.css">
	...
	<br>
		<div class="card">
			<form action="/account/StemmingServlet" method="post">
				<h1>Je hebt gekozen voor Verbazing...</h1>
					<p>Bij deze raadde we je dan natuurlijk een <b>BRILLER</b> film aan!</p>
