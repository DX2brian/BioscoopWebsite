...
<link rel="stylesheet" type="text/css" href="accountCss/mystyles7.css">
<style>
.gegevens {
	text-align: center;
}
	...
	<br>
		<div class="card">
			<form action="/account/StemmingServlet" method="post">
				<h1>Je hebt gekozen voor Afschuw...</h1>
					<p>Wie heeft er nou weer afschuw gekozen?</p>
					<p>Alsof wij een film kunnen bedenken waar je blij van word als voor <b>BRAFSCHUW</b> hebt gekozen...</p>
