...
<link rel="stylesheet" type="text/css" href="accountCss/mystyles3.css">
	...
	<br>
		<div class="card">
			<form action="/account/StemmingServlet" method="post">
				<h1>Je hebt gekozen voor Verdriet...</h1>
					<p>Bij deze raadde we je dan natuurlijk een <b>BRAMA</b> film aan!</p>
