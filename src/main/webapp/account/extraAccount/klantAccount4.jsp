...
<link rel="stylesheet" type="text/css" href="accountCss/mystyles4.css">
	...
	<br>
		<div class="card">
			<form action="/account/StemmingServlet" method="post">
				<h1>Je hebt gekozen voor Angst...</h1>
					<p>Bij deze raadde we je dan natuurlijk een <b>BRORROR</b> film aan!</p>
