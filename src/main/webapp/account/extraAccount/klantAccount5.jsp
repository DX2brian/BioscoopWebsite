...
<link rel="stylesheet" type="text/css" href="accountCss/mystyles5.css">
	...
	<br>
		<div class="card">
			<form action="/account/StemmingServlet" method="post">
				<h1>Je hebt gekozen voor Woede...</h1>
					<p>Bij deze raadde we je dan natuurlijk een <b>BRACTIE</b> film aan!</p>
