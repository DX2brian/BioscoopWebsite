	...
	<br>
		<div class="card">
			<form action="/account/StemmingServlet" method="post">
				<h1>Blij, boos, geïriteerd, of juist vrolijk?</h1>
					<p>Verander je stemming en wij kiezen dan een film genre voor je!</p>
				<button id="standaard" name=standaard value="1" type="submit">Standaard</button>
				<button id="vreugde" name=vreugde value="1" type="submit">Vreugde</button>
				<button id="verdriet" name=verdriet value="1" type="submit">Verdriet</button>
				<button id="angst" name=angst value="1" type="submit">Angst</button>
				<button id="woede" name=woede value="1" type="submit">Woede</button>
				<button id="verbazing" name=verbazing value="1" type="submit">Verbazing</button>
				<button id="afschuw" name=afschuw value="1" type="submit">Afschuw</button>
			</form>
		</div>
	<br>
		<div class="card">
