...
<body>
	...
	<div style="text-align:center;">
		<h1>Voeg een nieuw soort voedsel toe</h1>
	</div>
	
	<form action="/toevoegen/VoegEtenToeServlet" method="post">
	<div class="container">
		...
		<label>Voer hier de grootte in:</label> <br>
			<input type="text" name="grootte" ></input><br><br>
		<label>Voer hier het aantal gram in (getal tussen de 1 en 999):</label> <br>
			<input type="number" name="gram" required="required"></input><br><br>
		<input type="submit" value="voegEtenToe">
		</div>
	</form>
	</div>
